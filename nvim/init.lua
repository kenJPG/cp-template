...
-- lua/config/autopairs.lua is the one exception — it's our custom engine and is
-- pulled in from the bottom of keymaps.lua.
-- ============================================================================
...
require("lazy").setup({
  ...
  install = { colorscheme = { "catppuccin", "tokyonight-day", "default" } },
